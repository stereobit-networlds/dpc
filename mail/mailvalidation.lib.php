 ...
 *
 * @(#) $Header: c:\php\webos\cvs/mail/mailvalidation.lib.php,v 1.1.1.1 2006/05/02 09:07:18 administrator Exp $
 *
 */
...
class email_validation_class
{
	...
	Function ValidateEmailBox($email)
	{
		...
		for($host=0;$host<count($hosts);$host++)
		{
		    ...
		    //if ($connection=stream_socket_client("tcp://$ip:25", $errno, $error, 30)) 
