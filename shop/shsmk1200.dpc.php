<?php
$__DPCSEC['SHSMK1200_DPC']='1;1;1;1;1;1;2;2;9';
$__DPCSEC['SHSMK1200_CART']='1;1;1;1;1;1;2;2;9';

if ( (!defined("SHSMK1200_DPC")) && (seclevel('SHSMK1200_DPC',decode(GetSessionParam('UserSecID')))) ) {
define("SHSMK1200_DPC",true);

$__DPC['SHSMK1200_DPC'] = 'shsmk1200';

$d = GetGlobal('controller')->require_dpc('shop/shkatalog.dpc.php');
require_once($d);


$__EVENTS['SHSMK1200_DPC'][0]='mk1200';

$__ACTIONS['SHSMK1200_DPC'][0]='mk1200';

$__LOCALE['SHSMK1200_DPC'][0]='SHSMK1200_DPC;Shop Kiosk;Shop Kiosk';

class shsmk1200 extends shkatalog {
	...
	function shsmk1200() {
	  ...
	  $this->title = localize('SHSMK1200_DPC',getlocal());	
...
*/		
	   ...
	   $out .= '<hr><b>';//.mb_convert_encoding($mk1200item, "UTF-7");
	   $myprice = ($price-(($price*15)/100));
	   $out .= 'Παραλαβή απο την έδρα μας:'.$myprice . "&nbsp;&#8364<br></b>";
