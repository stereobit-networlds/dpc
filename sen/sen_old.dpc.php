       ...
       if (iniload('SEN')) {
	     ...
	     if (!$this->sen_db) {//$i++; echo $i . ">>>>>>>>>>>>";
		   ...
		   if (defined(_ADODB_)) { 
             ...
             $this->sen_db->PConnect($_Host2, $_User2, $_Password2, $_Dbname2);			 
             //$this->sen_db = ADONewConnection('odbc_oracle');
			 //$this->sen_db->PConnect('sen','S01001','S01001','sen_db');			 
             //$this->sen_db->PConnect('sen','I_USR','USR_VK7DP','sen_db');			 
			 
             //$this->sen_db = ADONewConnection('oci8');
             //$this->sen_db->PConnect('192.168.1.249','S01001','S01001','SEN_DB');			 			 
             //$cstr = "(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=192.168.1.249)(PORT=1521))
			 //         (CONNECT_DATA=(SID=SEN_DB)))";
	         //$this->sen_db->Connect($cstr, 'S01001', 'S01001');
			 
			 //echo 'SEN ADODB loaded !';
		   }
		   else {
		     //echo "SEN ADODB extension not loaded....";
		   }
		     
		   //$this->sen_db = ADONewConnection('oci8');
		   //$this->sen_db->PConnect('192.168.1.249:1521', 'S01001', 'S01001', 'sen_db');
