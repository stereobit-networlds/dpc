 ...
 * getmxrr.php
 *
 * @(#) $Header: c:\php\webos\cvs/tcp/getmxrr.lib.php,v 1.1.1.1 2006/05/02 08:16:26 administrator Exp $
 *
 */
...
//	require_once( 'DNS.lib.php' );
$d = GetGlobal('controller')->require_dpc('tcp/dns.lib.php');
require_once($d);
