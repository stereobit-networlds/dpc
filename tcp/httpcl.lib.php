 ...
 * http.php
 *
 * @(#) $Header: /home/mlemos/cvsroot/PHPlibrary/http.php,v 1.7 2002/01/12 02:39:57 mlemos Exp $
 *
 */
...
class http_class
{
	var $host_name="";
	var $host_port=80;
	var $proxy_host_name="";//"192.168.1.251";
		...
		for(;;)
		{
			...
			switch($header_name)
			{
				...
				case "set-cookie":
					...
					{
						$cookie_name=trim($this->Tokenize($headers[$header_name],"="));
